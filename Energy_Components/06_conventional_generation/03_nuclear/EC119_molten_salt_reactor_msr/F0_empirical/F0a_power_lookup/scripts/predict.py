"""Standardized prediction interface for the EC119 F0a power-map lookup."""
import json
import os
import numpy as np
...
class ComponentModel:
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {"load_factor": "dimensionless (0.3-1.0)"},
            "outputs": {
...
if __name__ == "__main__":
    ...
    print("sample @ load=0.65:", m.predict({"load_factor": 0.65}))
