"""Standardized prediction interface for the EC117 F0a power-map lookup."""
import json
import os
import numpy as np
...
class ComponentModel:
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {"load_factor": "dimensionless (0.6-1.0)"},
            "outputs": {
...
if __name__ == "__main__":
    ...
    print("sample @ load=0.8:", m.predict({"load_factor": 0.8}))
