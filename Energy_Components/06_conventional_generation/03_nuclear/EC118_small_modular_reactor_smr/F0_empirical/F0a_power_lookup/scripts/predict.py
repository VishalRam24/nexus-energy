"""Standardized prediction interface for the EC118 F0a power-map lookup."""
import json
import os
import numpy as np
...
class ComponentModel:
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {"load_factor": "dimensionless (0.2-1.0)"},
            "outputs": {
...
if __name__ == "__main__":
    ...
    print("sample @ load=0.6:", m.predict({"load_factor": 0.6}))
