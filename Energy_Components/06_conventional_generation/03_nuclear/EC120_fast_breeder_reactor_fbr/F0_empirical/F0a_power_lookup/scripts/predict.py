"""Standardized prediction interface for the EC120 F0a power-map lookup."""
import json
import os
import numpy as np
...
class ComponentModel:
    component_id = "EC120"
    component_name = "Fast Breeder Reactor (FBR)"
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {"load_factor": "dimensionless (0.25-1.0)"},
            "outputs": {
...
if __name__ == "__main__":
    ...
    print("sample @ load=0.62:", m.predict({"load_factor": 0.62}))
