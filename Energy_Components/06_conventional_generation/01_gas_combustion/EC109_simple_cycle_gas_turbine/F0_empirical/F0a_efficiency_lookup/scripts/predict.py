"""Standardized prediction interface for the EC109 F0a efficiency lookup."""
import json
import os
import numpy as np
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {
                ...
                "ambient_temp_c": "degC (optional, -20..50)",
            },
            "outputs": {
                "efficiency": "dimensionless net LHV",
                "power_output_mw": "MW",
                "fuel_power_mw": "MW (LHV)",
            },
            "rated_power_mw": self.P_rated,
...
if __name__ == "__main__":
    m = ComponentModel()
    print(m.get_info())
    print("sample @ PLR=1.0, 15C:", m.predict({"part_load_ratio": 1.0, "ambient_temp_c": 15.0}))
    print("sample @ PLR=0.5, 30C:", m.predict({"part_load_ratio": 0.5, "ambient_temp_c": 30.0}))
