"""Standardized prediction interface for the EC110 F0a efficiency lookup."""
import json
import os
import numpy as np
...
class ComponentModel:
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {
                "part_load_ratio": "dimensionless (0.5-1.0)",
...
if __name__ == "__main__":
    m = ComponentModel()
    print(m.get_info())
    print("sample @ PLR=1.0:", m.predict({"part_load_ratio": 1.0, "ambient_temp_c": 25.0}))
    print("sample @ PLR=0.6:", m.predict({"part_load_ratio": 0.6, "ambient_temp_c": 30.0}))
