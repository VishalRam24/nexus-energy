"""OPTIONAL Plotly efficiency-curve report for EC169 Variable Frequency Drive (VFD)."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC169 Variable Frequency Drive (VFD) -- F0a efficiency vs load",
