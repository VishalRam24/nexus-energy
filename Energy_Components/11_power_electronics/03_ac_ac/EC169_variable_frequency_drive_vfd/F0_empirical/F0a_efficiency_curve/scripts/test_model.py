"""F0a tailored tests for EC169 Variable Frequency Drive (VFD). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC169" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC169 Variable Frequency Drive (VFD) F0a")
    main()
