"""F0a empirical efficiency-vs-load lookup model for EC170 Solid-State Transformer (SST).
...
Data source: Huang et al. (2011), IEEE Trans. Ind. Electron., 58(7), 2799-2809
