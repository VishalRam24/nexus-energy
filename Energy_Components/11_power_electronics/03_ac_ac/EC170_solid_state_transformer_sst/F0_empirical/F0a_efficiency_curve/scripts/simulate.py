"""OPTIONAL Plotly efficiency-curve report for EC170 Solid-State Transformer (SST)."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC170 Solid-State Transformer (SST) -- F0a efficiency vs load",
