"""F0a tailored tests for EC170 Solid-State Transformer (SST). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC170" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC170 Solid-State Transformer (SST) F0a")
    main()
