"""F0a tailored tests for EC171 Cycloconverter. NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC171" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC171 Cycloconverter F0a")
    main()
