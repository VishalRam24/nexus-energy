"""OPTIONAL Plotly efficiency-curve report for EC166 AC-DC Rectifier (Diode Bridge)."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC166 AC-DC Rectifier (Diode Bridge) -- F0a efficiency vs load",
