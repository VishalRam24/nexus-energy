"""F0a tailored tests for EC166 AC-DC Rectifier (Diode Bridge). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC166" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC166 AC-DC Rectifier (Diode Bridge) F0a")
    main()
