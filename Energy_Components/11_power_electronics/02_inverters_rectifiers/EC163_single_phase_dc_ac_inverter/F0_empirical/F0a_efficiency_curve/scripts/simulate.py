"""OPTIONAL Plotly efficiency-curve report for EC163 Single-Phase DC-AC Inverter."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC163 Single-Phase DC-AC Inverter -- F0a efficiency vs load",
