"""F0a tailored tests for EC163 Single-Phase DC-AC Inverter. NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC163" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC163 Single-Phase DC-AC Inverter F0a")
    main()
