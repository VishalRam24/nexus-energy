"""F0a tailored tests for EC168 MPPT Controller. NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC168" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC168 MPPT Controller F0a")
    main()
