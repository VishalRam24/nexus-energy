"""F0a tailored tests for EC164 Three-Phase DC-AC Inverter. NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC164" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC164 Three-Phase DC-AC Inverter F0a")
    main()
