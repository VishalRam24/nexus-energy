"""OPTIONAL Plotly efficiency-curve report for EC164 Three-Phase DC-AC Inverter."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC164 Three-Phase DC-AC Inverter -- F0a efficiency vs load",
