"""F0a tailored tests for EC165 Multilevel Inverter (3-Level NPC). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC165" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC165 Multilevel Inverter (3-Level NPC) F0a")
    main()
