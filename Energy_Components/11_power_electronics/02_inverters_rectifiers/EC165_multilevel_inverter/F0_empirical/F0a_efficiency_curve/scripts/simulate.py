"""OPTIONAL Plotly efficiency-curve report for EC165 Multilevel Inverter (3-Level NPC)."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC165 Multilevel Inverter (3-Level NPC) -- F0a efficiency vs load",
