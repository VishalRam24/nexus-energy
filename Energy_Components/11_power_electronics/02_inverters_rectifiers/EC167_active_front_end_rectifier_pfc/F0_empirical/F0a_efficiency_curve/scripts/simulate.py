"""OPTIONAL Plotly efficiency-curve report for EC167 Active Front End Rectifier (PFC)."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC167 Active Front End Rectifier (PFC) -- F0a efficiency vs load",
