"""F0a tailored tests for EC167 Active Front End Rectifier (PFC). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC167" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC167 Active Front End Rectifier (PFC) F0a")
    main()
