"""F0a empirical 1-D lookup model for EC181 Transmission Line.
...
Source (reused from F1a): Glover, Sarma, Overbye (2012), Power Systems Analysis and Design, 5th ed. (reused from F1a)
"""
import numpy as np
