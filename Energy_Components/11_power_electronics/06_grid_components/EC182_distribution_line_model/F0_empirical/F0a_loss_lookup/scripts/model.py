"""F0a empirical 1-D lookup model for EC182 Distribution Line.
...
Source (reused from F1a): Kersting (2012), Distribution System Modeling and Analysis, 3rd ed. (reused from F1a)
"""
import numpy as np
