"""F0a empirical 1-D lookup model for EC187 HVDC Converter Station.
...
Source (reused from F1a): Cigre TB 492 (2012), VSC Transmission; ABB HVDC Reference Projects (reused from F1a)
"""
import numpy as np
