"""F0a optional Plotly report for EC185 Static VAR Compensator (SVC). Safe if Plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC185 Static VAR Compensator (SVC) — F0a converter loss",
