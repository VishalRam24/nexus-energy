"""F0a empirical predict interface for EC184 Power Factor Correction Unit."""
import json
import os
...
class ComponentModel:
    component_id = "EC184"
    component_name = "Power Factor Correction Unit"
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {"q_demand": "requested reactive output (kVAR)"},
            "outputs": {"q_out": "kVAR (clamped to [Q_min, Q_max])",
                        "q_clamped": "bool", "loss_fraction": "dimensionless",
                        "loss": "kVAR (active loss)"},
