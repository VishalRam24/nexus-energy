"""F0a empirical 1-D lookup model for EC184 Power Factor Correction Unit.
...
Source (reused from F1a): Acha et al. (2004), FACTS: Modelling and Simulation in Power Networks (reused from F1a)
"""
import numpy as np
