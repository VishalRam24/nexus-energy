"""F0a tailored tests for EC159 Buck-Boost Converter. NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC159" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC159 Buck-Boost Converter F0a")
    main()
