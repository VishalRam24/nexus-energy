"""F0a tailored tests for EC161 Dual Active Bridge (DAB). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC161" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC161 Dual Active Bridge (DAB) F0a")
    main()
