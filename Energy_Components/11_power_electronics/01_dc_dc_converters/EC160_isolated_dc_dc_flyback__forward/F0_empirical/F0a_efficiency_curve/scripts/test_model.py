"""F0a tailored tests for EC160 Isolated DC-DC Flyback/Forward. NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC160" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC160 Isolated DC-DC Flyback/Forward F0a")
    main()
