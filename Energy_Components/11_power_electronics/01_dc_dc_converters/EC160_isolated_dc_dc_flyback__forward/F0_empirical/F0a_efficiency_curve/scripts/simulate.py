"""OPTIONAL Plotly efficiency-curve report for EC160 Isolated DC-DC Flyback/Forward."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC160 Isolated DC-DC Flyback/Forward -- F0a efficiency vs load",
