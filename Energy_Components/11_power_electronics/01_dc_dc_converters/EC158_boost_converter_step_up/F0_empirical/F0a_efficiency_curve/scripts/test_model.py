"""F0a tailored tests for EC158 Boost Converter (Step-Up). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC158" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC158 Boost Converter (Step-Up) F0a")
    main()
