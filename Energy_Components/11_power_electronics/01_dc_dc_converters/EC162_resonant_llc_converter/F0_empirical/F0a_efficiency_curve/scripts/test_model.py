"""F0a tailored tests for EC162 Resonant LLC Converter. NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC162" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC162 Resonant LLC Converter F0a")
    main()
