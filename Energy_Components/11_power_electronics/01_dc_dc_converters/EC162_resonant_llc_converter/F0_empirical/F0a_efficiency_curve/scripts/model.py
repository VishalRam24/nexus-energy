"""F0a empirical efficiency-vs-load lookup model for EC162 Resonant LLC Converter.
...
Data source: Yang et al. (2002), APEC; Liu et al. (2012), IEEE Trans. Power Electron.
