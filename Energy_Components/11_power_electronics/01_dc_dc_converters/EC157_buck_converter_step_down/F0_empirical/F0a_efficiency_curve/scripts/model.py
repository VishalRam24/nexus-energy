"""F0a empirical efficiency-vs-load lookup model for EC157 Buck Converter (Step-Down).
...
Data source: Erickson & Maksimovic (2020), Fundamentals of Power Electronics, 3rd ed., Springer
