"""OPTIONAL Plotly efficiency-curve report for EC157 Buck Converter (Step-Down)."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC157 Buck Converter (Step-Down) -- F0a efficiency vs load",
