"""F0a empirical part-load efficiency-curve lookup for EC177 Brushless DC Motor (BLDC).
...
Source (reused from F1a): Hanselman (2006), Brushless Permanent Magnet Motor Design (reused from F1a)
"""
import numpy as np
