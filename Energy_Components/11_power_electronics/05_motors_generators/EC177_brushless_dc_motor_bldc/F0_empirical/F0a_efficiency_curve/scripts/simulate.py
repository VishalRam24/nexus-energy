"""F0a optional Plotly report for EC177 Brushless DC Motor (BLDC). Safe if Plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC177 Brushless DC Motor (BLDC) — F0a efficiency",
