"""F0a optional Plotly report for EC180 Doubly-Fed Induction Generator (DFIG). Safe if Plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC180 Doubly-Fed Induction Generator (DFIG) — F0a efficiency",
