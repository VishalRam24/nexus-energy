"""F0a empirical part-load efficiency-curve lookup for EC180 Doubly-Fed Induction Generator (DFIG).
...
Source (reused from F1a): Muller et al. (2002); IEC 61400-21 (reused from F1a)
"""
import numpy as np
