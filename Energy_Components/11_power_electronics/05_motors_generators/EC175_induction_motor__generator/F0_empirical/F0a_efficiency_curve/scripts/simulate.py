"""F0a optional Plotly report for EC175 Induction Motor/Generator. Safe if Plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC175 Induction Motor/Generator — F0a efficiency",
