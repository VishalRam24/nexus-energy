"""F0a empirical part-load efficiency-curve lookup for EC175 Induction Motor/Generator.
...
Source (reused from F1a): IEC 60034-30-1:2014; Boldea & Nasar (2010) (reused from F1a)
"""
import numpy as np
