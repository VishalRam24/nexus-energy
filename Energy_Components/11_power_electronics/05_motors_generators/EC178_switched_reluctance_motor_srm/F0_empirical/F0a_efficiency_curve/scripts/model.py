"""F0a empirical part-load efficiency-curve lookup for EC178 Switched Reluctance Motor (SRM).
...
Source (reused from F1a): Krishnan (2001), Switched Reluctance Motor Drives (reused from F1a)
"""
import numpy as np
