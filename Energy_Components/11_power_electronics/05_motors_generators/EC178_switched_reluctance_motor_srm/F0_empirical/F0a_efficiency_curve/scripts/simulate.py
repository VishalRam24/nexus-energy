"""F0a optional Plotly report for EC178 Switched Reluctance Motor (SRM). Safe if Plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC178 Switched Reluctance Motor (SRM) — F0a efficiency",
