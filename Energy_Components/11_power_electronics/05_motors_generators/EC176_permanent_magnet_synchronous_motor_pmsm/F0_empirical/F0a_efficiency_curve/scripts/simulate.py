"""F0a optional Plotly report for EC176 Permanent Magnet Synchronous Motor (PMSM). Safe if Plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC176 Permanent Magnet Synchronous Motor (PMSM) — F0a efficiency",
