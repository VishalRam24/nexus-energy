"""F0a empirical part-load efficiency-curve lookup for EC176 Permanent Magnet Synchronous Motor (PMSM).
...
Source (reused from F1a): Gieras (2010), Permanent Magnet Motor Technology, 3rd ed. (reused from F1a)
"""
import numpy as np
