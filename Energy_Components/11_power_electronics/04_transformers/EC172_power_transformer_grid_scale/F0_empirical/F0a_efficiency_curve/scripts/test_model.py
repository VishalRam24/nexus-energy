"""F0a tailored tests for EC172 Power Transformer (Grid-Scale). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    info = cm.get_info()
    assert_true(info["component_id"] == "EC172" and "source" in info,
...
if __name__ == "__main__":
    print("Testing EC172 Power Transformer (Grid-Scale) F0a")
    main()
