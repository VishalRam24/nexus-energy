"""F0a empirical part-load efficiency-curve lookup for EC173 Distribution Transformer.
...
Source (reused from F1a): IEC 60076-1:2011; IEEE C57.12.00-2015 (reused from F1a)
"""
import numpy as np
