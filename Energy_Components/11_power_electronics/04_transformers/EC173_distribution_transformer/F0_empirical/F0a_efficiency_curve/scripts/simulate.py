"""F0a optional Plotly report for EC173 Distribution Transformer. Safe if Plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC173 Distribution Transformer — F0a efficiency",
