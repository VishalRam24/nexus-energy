"""F0a empirical power-curve lookup for EC064 Small/Micro Wind Turbine (10 kW).
...
Data source: Manwell et al. (2009). Wind Energy Explained. 2nd ed.; IEC 61400-2 (cubic-ramp simplification of P=0.5*rho*Cp*A*v^3)
"""
import numpy as np
