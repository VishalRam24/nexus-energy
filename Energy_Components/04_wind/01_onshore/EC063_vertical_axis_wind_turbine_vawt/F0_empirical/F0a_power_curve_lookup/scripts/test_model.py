"""Tailored tests for EC063 F0a empirical power-curve lookup (no pytest)."""
import os
import sys
import time
...
print(f"Testing EC063 F0a power-curve lookup")
...
p_rated = m.predict({"wind_speed": 11.0})["power_kw"]
