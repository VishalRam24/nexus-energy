"""F0a empirical power-curve lookup for EC062 HAWT Onshore Wind Turbine (Vestas V90-2.0MW).
...
Data source: windpowerlib database / Vestas V90 datasheet; IEC 61400-12-1
"""
import numpy as np
