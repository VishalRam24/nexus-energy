"""Tailored tests for EC062 F0a empirical power-curve lookup (no pytest)."""
import os
import sys
import time
...
print(f"Testing EC062 F0a power-curve lookup")
...
p_rated = m.predict({"wind_speed": 16.0})["power_kw"]
