"""F0a empirical power-curve lookup for EC066 Offshore Floating Wind Turbine (IEA 15 MW).
...
Data source: Gaertner et al. (2020) NREL/TP-5000-75698 (IEA 15 MW); UMaine VolturnUS-S
"""
import numpy as np
