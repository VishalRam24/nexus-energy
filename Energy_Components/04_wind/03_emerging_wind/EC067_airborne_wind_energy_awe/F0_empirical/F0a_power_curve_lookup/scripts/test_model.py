"""Tailored tests for EC067 F0a empirical power-curve lookup (no pytest)."""
import os
import sys
import time
...
print(f"Testing EC067 F0a power-curve lookup")
...
p_rated = m.predict({"wind_speed": 15.0})["power_kw"]
