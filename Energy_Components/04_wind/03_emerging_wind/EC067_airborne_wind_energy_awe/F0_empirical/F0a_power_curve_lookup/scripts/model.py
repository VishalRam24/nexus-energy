"""F0a empirical power-curve lookup for EC067 Airborne Wind Energy Crosswind Kite (100 kW).
...
Data source: Loyd (1980) Crosswind kite power, J. Energy; Diehl (2013) Airborne Wind Energy, Springer (cubic-ramp simplification)
"""
import numpy as np
