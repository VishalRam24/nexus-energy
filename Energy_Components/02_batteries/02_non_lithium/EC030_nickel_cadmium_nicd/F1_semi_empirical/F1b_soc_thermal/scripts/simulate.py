"""
EC030 -- NiCd Battery -- F1b SOC-Thermal -- Simulation & HTML Report Generator
"""
...
def generate_report():
    ...
    temperatures = [243.15, 273.15, 298.15, 313.15, 333.15]
    temp_labels = ["-30C (243K)", "0C (273K)", "25C (298K)", "40C (313K)", "60C (333K)"]
    colors = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd"]

    soc = np.linspace(0.05, 0.95, 200)
    discharge_current = 10.0  # A (1C for 10Ah cell)
