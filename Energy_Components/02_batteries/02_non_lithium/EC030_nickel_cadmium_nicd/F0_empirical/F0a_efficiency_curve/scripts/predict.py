"""
EC030 -- Nickel-Cadmium (NiCd) Battery -- F0a predict interface.
...
from model import NiCdBatteryF0a
...
class ComponentModel:
    ...
    def __init__(self, params_path=None):
        ...
        self.model = NiCdBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {
                "c_rate": "C-rate (dimensionless, 0..10.0)",
            ...
            "valid_ranges": {"c_rate": [0.0, 10.0]},
            "source": 'NiCd SOC-only F1a defaults (Q_nom=2.0 Ah, R_int=20 mOhm, flat OCV 1.0-1.35 V)',
        }
