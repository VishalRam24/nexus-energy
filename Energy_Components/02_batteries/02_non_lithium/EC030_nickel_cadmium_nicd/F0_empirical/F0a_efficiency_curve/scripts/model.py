"""
EC030 -- Nickel-Cadmium (NiCd) Battery -- F0 Empirical Round-Trip Efficiency Curve
...
Reference (reused from F1a):
    NiCd SOC-only F1a defaults (Q_nom=2.0 Ah, R_int=20 mOhm, flat OCV 1.0-1.35 V)
"""

import numpy as np


class NiCdBatteryF0a:
    """Round-trip-efficiency lookup model for the EC030 cell."""
...
if __name__ == "__main__":
    ...
    m = NiCdBatteryF0a(json.load(open(p)))
