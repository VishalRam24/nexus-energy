...
Na-ion characteristics: slightly higher alpha_c than Li-ion, moderate E_a.
...
class NaIonBatteryF1b:
    """Sodium-ion battery cell model -- voltage as a function of SOC, current, and temperature."""
