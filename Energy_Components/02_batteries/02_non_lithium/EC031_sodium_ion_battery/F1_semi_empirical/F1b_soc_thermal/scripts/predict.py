"""
EC031 -- Sodium-Ion Battery -- F1b SOC-Thermal -- Standardized Predict Interface
...
from model import NaIonBatteryF1b


class ComponentModel:
    """Standardized interface for EC031 Sodium-Ion Battery -- F1b SOC-thermal model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = NaIonBatteryF1b(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": "Tremblay & Dessaint (2009); Hwang et al. (2017); Rudola et al. (2021)",
        }
