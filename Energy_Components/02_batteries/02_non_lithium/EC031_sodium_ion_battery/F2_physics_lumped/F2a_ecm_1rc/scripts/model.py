"""
EC031 -- Sodium-Ion Battery -- F2a ECM 1-RC Model
...
Reference:
    CATL first-gen Na-ion data; Tremblay & Dessaint (2009) framework adapted.
"""

import numpy as np


class NaIonBatteryECM1RC:
    """1-RC equivalent circuit model for Na-ion battery."""
