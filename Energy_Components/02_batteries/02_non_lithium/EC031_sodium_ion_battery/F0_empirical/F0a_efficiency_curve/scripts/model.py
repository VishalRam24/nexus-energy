"""
EC031 -- Sodium-Ion Battery -- F0 Empirical Round-Trip Efficiency Curve
...
Reference (reused from F1a):
    Tremblay & Dessaint (2009) framework adapted for Na-ion; CATL first-gen Na-ion data
"""

import numpy as np


class SodiumIonBatteryF0a:
    """Round-trip-efficiency lookup model for the EC031 cell."""
...
if __name__ == "__main__":
    ...
    m = SodiumIonBatteryF0a(json.load(open(p)))
