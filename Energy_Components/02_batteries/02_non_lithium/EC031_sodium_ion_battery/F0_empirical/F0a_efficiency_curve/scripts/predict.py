"""
EC031 -- Sodium-Ion Battery -- F0a predict interface.
...
from model import SodiumIonBatteryF0a


class ComponentModel:
    component_id = "EC031"
    component_name = "Sodium-Ion Battery"
    ...
    def __init__(self, params_path=None):
        ...
        self.model = SodiumIonBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": 'Tremblay & Dessaint (2009) framework adapted for Na-ion; CATL first-gen Na-ion data',
        }
