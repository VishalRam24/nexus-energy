"""Optional Plotly report for Iron-Air Battery (EC033) F0a. Wrapped so absence of plotly is harmless."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="Iron-Air Battery (EC033) F0a round-trip efficiency",
