"""
EC029 -- Nickel-Metal Hydride (NiMH) Battery -- F0a predict interface.
...
class ComponentModel:
    ...
    def __init__(self, params_path=None):
        ...
        self.model = NiMHBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {
                "c_rate": "C-rate (dimensionless, 0..5.0)",
            ...
            "source": "Linden's Handbook of Batteries (4th ed., 2011), ch. 31; Panasonic NiMH datasheets",
        }
