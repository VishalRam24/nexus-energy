"""
EC029 -- Nickel-Metal Hydride (NiMH) Battery -- F0 Empirical Round-Trip Efficiency Curve
...
Reference (reused from F1a):
    Linden's Handbook of Batteries (4th ed., 2011), ch. 31; Panasonic NiMH datasheets
"""

import numpy as np


class NiMHBatteryF0a:
    """Round-trip-efficiency lookup model for the EC029 cell."""
...
if __name__ == "__main__":
    ...
    m = NiMHBatteryF0a(json.load(open(p)))
