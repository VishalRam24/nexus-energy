"""
EC029 -- NiMH Battery -- F1b SOC-Thermal -- Standardized Predict Interface
...
from model import NiMHBatteryF1b


class ComponentModel:
    """Standardized interface for EC029 NiMH Battery -- F1b SOC-thermal model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = NiMHBatteryF1b(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "ec_id": "EC029",
            "fidelity": "F1b",
            "description": "SOC-thermal model; NiMH 1.2V, -20 to 60 degC, positive dOCV/dT (unlike Li-ion)",
            "inputs": {
            ...
            "source": "Linden (2011); Bernardi & Carpenter (1995); Khun et al. (2006)",
        }
...
if __name__ == "__main__":
    ...
    result = model.predict({"soc": 0.5, "current": 2.0, "temperature": 298.15})
    print(f"\nAt SOC=0.5, I=2.0A (1C), T=298.15K:")
