"""EC029 — NiMH Battery — F1a SOC-Only — Simulation & HTML Report Generator"""
...
def generate_report():
    ...
    c_rates = [0.0, 0.2, 0.5, 1.0, 2.0, 3.0]
    ...
    for i, (c, I) in enumerate(zip(c_rates, currents)):
        ...
        fig.add_trace(go.Scatter(x=soc, y=result["voltage"], name=f"{c}C ({I:.1f}A)",
