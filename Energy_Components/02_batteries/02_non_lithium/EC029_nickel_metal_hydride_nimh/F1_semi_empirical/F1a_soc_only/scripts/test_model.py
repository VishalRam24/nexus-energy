"""EC029 — NiMH Battery — F1a SOC-Only — Test Suite"""
...
def test_voltage_drops_with_discharge_current(model):
    currents = np.array([0.0, 1.0, 3.0, 5.0, 10.0])
