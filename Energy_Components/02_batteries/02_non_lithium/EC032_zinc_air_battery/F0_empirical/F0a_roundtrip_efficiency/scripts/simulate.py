"""Optional Plotly report for Zinc-Air Battery (EC032) F0a. Wrapped so absence of plotly is harmless."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="Zinc-Air Battery (EC032) F0a round-trip efficiency",
