"""F0a empirical round-trip-efficiency lookup for Zinc-Air Battery (EC032).
...
Data source (reused from EC032 F1a):
EC032 F1a (V_nom=1.65 V, R_int=50 mOhm, Q_nom=3.0 Ah); Zn+O2->ZnO. Round-trip eff ~55-60% (Li, Y.; Lu, J. ACS Energy Lett. 2017).
