"""Tailored tests for Sodium-Sulfur (NaS) Battery (EC035) F0a round-trip-efficiency lookup. No pytest."""
import os
import sys
import time
...
def main():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC035" and info["version"] == "1.0.0",
