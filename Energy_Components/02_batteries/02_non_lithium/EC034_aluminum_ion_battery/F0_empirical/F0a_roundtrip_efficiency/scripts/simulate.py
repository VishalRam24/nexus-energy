"""Optional Plotly report for Aluminum-Ion Battery (EC034) F0a. Wrapped so absence of plotly is harmless."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="Aluminum-Ion Battery (EC034) F0a round-trip efficiency",
