"""F0a empirical round-trip-efficiency lookup for Aluminum-Ion Battery (EC034).
...
Data source (reused from EC034 F1a):
EC034 F1a (V_nom~2.0 V, R_int=80 mOhm, Q_nom=1.0 Ah); Al/graphite. Round-trip eff ~80-90% (Lin, M.-C. et al. Nature 2015).
