"""
EC028 -- Lead-Acid Battery -- F0a predict interface.
...
class ComponentModel:
    component_id = "EC028"
    component_name = "Lead-Acid Battery"
    ...
    def __init__(self, params_path=None):
        ...
        self.model = LeadAcidBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": 'Copetti et al. (1993), J. Power Sources 47(1):109-118; Manwell & McGowan (1993), Sol. Energy 50(5):399-405',
        }
