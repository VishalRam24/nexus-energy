"""
EC028 -- Lead-Acid Battery -- F1b SOC-Thermal -- Standardized Predict Interface

Usage:
    model = ComponentModel()
    result = model.predict({"soc": 0.5, "current": 10.0, "temperature": 298.15})
"""

import json
import numpy as np
from pathlib import Path
from model import LeadAcidF1b


class ComponentModel:
    """Standardized interface for EC028 Lead-Acid Battery -- F1b SOC-thermal model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = LeadAcidF1b(self.params)
    ...
    def get_info(self) -> dict:
        return {
            "name": "Lead-Acid Battery (Flooded)",
            "ec_id": "EC028",
            "fidelity": "F1b",
            "description": "SOC-thermal voltage model with Arrhenius R(T), Peukert correction, and capacity temperature dependence",
            "inputs": {
            ...
            "source": "Copetti et al. (1993); Manwell & McGowan (1993); Bode (1977)",
        }
