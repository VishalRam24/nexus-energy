"""Optional Plotly report for Hybrid Supercapacitor (EC043) F0a. Wrapped so absence of plotly is harmless."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="Hybrid Supercapacitor (EC043) F0a stored energy 0.5CV^2",
