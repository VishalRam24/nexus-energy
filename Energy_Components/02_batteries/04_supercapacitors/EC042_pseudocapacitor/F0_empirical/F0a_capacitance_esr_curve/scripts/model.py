"""F0a empirical capacitance/ESR lookup for Pseudocapacitor (EC042).
...
Data source (reused from EC042 F1a):
EC042 F1a (C=500 F, ESR=5 mOhm, V_max=2.7 V); Conway (1999), pseudocapacitance. DC round-trip eff ~95-98%.
