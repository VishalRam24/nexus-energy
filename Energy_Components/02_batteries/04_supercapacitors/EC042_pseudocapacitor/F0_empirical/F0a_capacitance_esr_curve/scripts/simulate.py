"""Optional Plotly report for Pseudocapacitor (EC042) F0a. Wrapped so absence of plotly is harmless."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="Pseudocapacitor (EC042) F0a stored energy 0.5CV^2",
