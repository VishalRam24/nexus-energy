"""F0a empirical capacitance/ESR lookup for EDLC Supercapacitor (EC041).
...
Data source (reused from EC041 F1a):
EC041 F1a (C=3000 F, ESR=0.29 mOhm, V_max=2.7 V); Maxwell BCAP3000; Conway (1999). DC round-trip eff >98%.
