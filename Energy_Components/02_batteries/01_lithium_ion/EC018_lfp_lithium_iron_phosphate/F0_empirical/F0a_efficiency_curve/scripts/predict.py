"""
EC018 -- LFP Battery (Lithium Iron Phosphate) -- F0a predict interface.
...
from model import LFPBatteryF0a


class ComponentModel:
    component_id = "EC018"
    component_name = "LFP Battery (Lithium Iron Phosphate)"
    ...
    def __init__(self, params_path=None):
        ...
        self.model = LFPBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {
                "c_rate": "C-rate (dimensionless, 0..7.0)",
            ...
            "valid_ranges": {"c_rate": [0.0, 7.0]},
            "source": 'Chen et al. (2020), J. Electrochem. Soc., 167, 080534; A123 ANR26650M1B datasheet',
        }
