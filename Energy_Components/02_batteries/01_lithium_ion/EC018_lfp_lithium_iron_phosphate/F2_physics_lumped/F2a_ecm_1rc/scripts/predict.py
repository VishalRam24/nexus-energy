"""
EC018 -- LFP Battery -- F2a ECM 1-RC -- Standardized Predict Interface
"""

import json
import numpy as np
from pathlib import Path
from model import LFPBatteryECM1RC


class ComponentModel:
    """Standardized interface for EC018 LFP Battery -- F2a 1-RC ECM."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = LFPBatteryECM1RC(self.params)
