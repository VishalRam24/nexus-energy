"""
EC018 -- LFP Battery -- F2a ECM 1-RC Model
...
Reference:
    Chen et al. (2020). J. Electrochem. Soc., 167, 080534; A123 datasheet.
"""

import numpy as np


class LFPBatteryECM1RC:
    """1-RC equivalent circuit model for LFP battery."""
