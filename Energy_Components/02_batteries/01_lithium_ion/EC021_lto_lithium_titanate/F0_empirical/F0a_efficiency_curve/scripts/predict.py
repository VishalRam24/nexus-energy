"""
EC021 -- LTO Battery (Lithium Titanate Oxide) -- F0a predict interface.
...
from model import LTOBatteryF0a
...
class ComponentModel:
    ...
    def __init__(self, params_path=None):
        ...
        self.model = LTOBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": 'Takami et al. (2011), J. Power Sources 196, 6989; Toshiba SCiB datasheet',
        }
