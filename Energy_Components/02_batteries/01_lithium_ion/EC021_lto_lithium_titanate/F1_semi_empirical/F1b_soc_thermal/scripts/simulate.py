"""
EC021 -- LTO Battery -- F1b SOC-Thermal -- Simulation & HTML Report Generator

Generates interactive Plotly charts showing:
1. V vs SOC at different temperatures (243K, 263K, 298K, 313K, 333K)
...
def generate_report():
    ...
    discharge_current = 2.9  # A (1C for 2.9 Ah cell)
    ...
    currents = np.linspace(0.0, 30.0, 200)
    for i, (T, label) in enumerate(zip(temperatures, temp_labels)):
        q_vals = []
        for I in currents:
