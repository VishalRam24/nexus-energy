"""
EC026 -- Lithium-Air (Li-Air) Battery -- F0a predict interface.
...
from model import LiAirBatteryF0a


class ComponentModel:
    component_id = "EC026"
    component_name = "Lithium-Air (Li-Air) Battery"
    ...
    def __init__(self, params_path=None):
        ...
        self.model = LiAirBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {
                "c_rate": "C-rate (dimensionless, 0..0.5)",
            ...
            "valid_ranges": {"c_rate": [0.0, 0.5]},
            "source": 'Li-Air F1a defaults (Q_nom=10 Ah, R_int=200 mOhm, flat OCV ~2.96 V from O2 reduction)',
        }
