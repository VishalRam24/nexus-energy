"""
EC020 -- NCA Battery -- F1b SOC-Thermal -- Standardized Predict Interface
...
from model import NCABatteryF1b


class ComponentModel:
    """Standardized interface for EC020 NCA Battery -- F1b SOC-thermal model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = NCABatteryF1b(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": "Tremblay & Dessaint (2009); Schuster et al. (2015); Viswanathan et al. (2010)",
        }
