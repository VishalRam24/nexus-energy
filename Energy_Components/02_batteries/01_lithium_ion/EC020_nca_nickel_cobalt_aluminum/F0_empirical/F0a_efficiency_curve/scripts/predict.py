"""
EC020 -- NCA Battery (Nickel-Cobalt-Aluminum) -- F0a predict interface.
...
from model import NCABatteryF0a


class ComponentModel:
    component_id = "EC020"
    component_name = "NCA Battery (Nickel-Cobalt-Aluminum)"
    ...
    def __init__(self, params_path=None):
        ...
        self.model = NCABatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {
                "c_rate": "C-rate (dimensionless, 0..4.5)",
            ...
            "valid_ranges": {"c_rate": [0.0, 4.5]},
            "source": 'Tremblay & Dessaint (2009), IEEE Trans. Veh. Technol.; Panasonic NCR18650B datasheet',
        }
