"""
EC027 -- Solid-State Lithium Battery -- F0a predict interface.
...
from model import SolidStateBatteryF0a
...
class ComponentModel:
    ...
    def __init__(self, params_path=None):
        ...
        self.model = SolidStateBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": 'Janek & Zeier (2016), Nat. Energy 1, 16141; QuantumScape & Solid Power patents',
        }
