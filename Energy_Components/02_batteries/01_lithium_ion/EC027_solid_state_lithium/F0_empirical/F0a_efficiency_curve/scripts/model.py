"""
EC027 -- Solid-State Lithium Battery -- F0 Empirical Round-Trip Efficiency Curve
...
Reference (reused from F1a):
    Janek & Zeier (2016), Nat. Energy 1, 16141; QuantumScape & Solid Power patents
"""

import numpy as np


class SolidStateBatteryF0a:
    """Round-trip-efficiency lookup model for the EC027 cell."""
...
if __name__ == "__main__":
    ...
    m = SolidStateBatteryF0a(json.load(open(p)))
