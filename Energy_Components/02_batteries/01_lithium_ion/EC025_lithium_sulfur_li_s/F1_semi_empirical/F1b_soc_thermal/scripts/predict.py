"""
EC025 -- Lithium-Sulfur Battery -- F1b SOC-Thermal -- Standardized Predict Interface
...
from model import LiSBatteryF1b


class ComponentModel:
    """Standardized interface for EC025 Li-S Battery -- F1b SOC-thermal model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = LiSBatteryF1b(self.params)
    ...
    def get_info(self) -> dict:
        return {
            "name": "Lithium-Sulfur Battery (Li-S)",
            "ec_id": "EC025",
            "fidelity": "F1b",
            "description": "SOC-thermal voltage model with Arrhenius R(T) and capacity correction. dOCV/dT is POSITIVE (+0.35 mV/K), giving endothermic reversible heat during discharge.",
            "inputs": {
                "soc": {"unit": "dimensionless", "range": [0.0, 1.0]},
                "current": {"unit": "A", "range": [-6.0, 6.0],
            ...
            "outputs": {
                ...
                "power": {"unit": "W"},
                "heat_generation": {"unit": "W", "note": "Can be negative at low currents (endothermic) - physically correct for Li-S"},
                "effective_capacity": {"unit": "Ah"},
                "internal_resistance": {"unit": "Ohm"},
                "ocv": {"unit": "V"},
                "dsoc_dt": {"unit": "1/s"},
            },
            "source": "Wild et al. (2015); Kumaresan et al. (2008); Cuisinier et al. (2014)",
        }
