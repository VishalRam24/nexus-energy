"""
EC025 -- Lithium-Sulfur (Li-S) Battery -- F0 Empirical Round-Trip Efficiency Curve
...
Reference (reused from F1a):
    Li-S two-plateau F1a defaults (Q_nom=5.0 Ah, R_int=100 mOhm, V 1.7-2.45 V)
"""
...
class LiSBatteryF0a:
    """Round-trip-efficiency lookup model for the EC025 cell."""
...
if __name__ == "__main__":
    ...
    m = LiSBatteryF0a(json.load(open(p)))
