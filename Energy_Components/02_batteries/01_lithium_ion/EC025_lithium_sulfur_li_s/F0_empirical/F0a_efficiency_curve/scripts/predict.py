"""
EC025 -- Lithium-Sulfur (Li-S) Battery -- F0a predict interface.
...
from model import LiSBatteryF0a
...
class ComponentModel:
    ...
    def __init__(self, params_path=None):
        ...
        self.model = LiSBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {
                "c_rate": "C-rate (dimensionless, 0..1.0)",
            ...
            "valid_ranges": {"c_rate": [0.0, 1.0]},
            "source": 'Li-S two-plateau F1a defaults (Q_nom=5.0 Ah, R_int=100 mOhm, V 1.7-2.45 V)',
        }
