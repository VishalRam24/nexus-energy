"""
EC024 -- Silicon-Anode Li-ion Battery -- F1b SOC-Thermal -- Simulation & HTML Report Generator
"""
...
def generate_report():
    ...
    discharge_current = 3.5  # A (1C for 3.5Ah cell)
    ...
    currents = np.linspace(0.0, 17.5, 200)
    for i, (T, label) in enumerate(zip(temperatures, temp_labels)):
