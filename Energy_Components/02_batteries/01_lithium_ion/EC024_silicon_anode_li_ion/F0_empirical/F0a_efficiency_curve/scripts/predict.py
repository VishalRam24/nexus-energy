"""
EC024 -- Silicon-Anode Li-ion Battery -- F0a predict interface.
...
from model import SiAnodeBatteryF0a


class ComponentModel:
    component_id = "EC024"
    component_name = "Silicon-Anode Li-ion Battery"
    ...
    def __init__(self, params_path=None):
        ...
        self.model = SiAnodeBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": 'Silicon-anode Li-ion F1a defaults (Q_nom=4.0 Ah, R_int=50 mOhm, V 2.8-4.2 V; Si ~3590 mAh/g)',
        }
