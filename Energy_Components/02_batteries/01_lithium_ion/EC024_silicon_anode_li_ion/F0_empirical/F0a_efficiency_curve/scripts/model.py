"""
EC024 -- Silicon-Anode Li-ion Battery -- F0 Empirical Round-Trip Efficiency Curve
...
Reference (reused from F1a):
    Silicon-anode Li-ion F1a defaults (Q_nom=4.0 Ah, R_int=50 mOhm, V 2.8-4.2 V; Si ~3590 mAh/g)
"""

import numpy as np


class SiAnodeBatteryF0a:
    """Round-trip-efficiency lookup model for the EC024 cell."""
...
if __name__ == "__main__":
    ...
    m = SiAnodeBatteryF0a(json.load(open(p)))
