"""
EC022 -- LCO Battery (Lithium Cobalt Oxide) -- F0 Empirical Round-Trip Efficiency Curve
...
Reference (reused from F1a):
    Reimers & Dahn (1992), J. Electrochem. Soc. 139, 2091; consumer-electronics LCO datasheets
"""
...
class LCOBatteryF0a:
    """Round-trip-efficiency lookup model for the EC022 cell."""
...
if __name__ == "__main__":
    ...
    m = LCOBatteryF0a(json.load(open(p)))
