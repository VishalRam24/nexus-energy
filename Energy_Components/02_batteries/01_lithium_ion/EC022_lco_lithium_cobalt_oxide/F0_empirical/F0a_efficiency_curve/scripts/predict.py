"""
EC022 -- LCO Battery (Lithium Cobalt Oxide) -- F0a predict interface.
...
from model import LCOBatteryF0a
...
class ComponentModel:
    ...
    def __init__(self, params_path=None):
        ...
        self.model = LCOBatteryF0a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": 'Reimers & Dahn (1992), J. Electrochem. Soc. 139, 2091; consumer-electronics LCO datasheets',
        }
