"""
EC019 -- NMC Battery -- F1b SOC-Thermal -- Standardized Predict Interface

Usage:
    model = ComponentModel()
    result = model.predict({"soc": 0.5, "current": 2.5, "temperature": 298.15})
"""

import json
import numpy as np
from pathlib import Path
from model import NMCBatteryF1b


class ComponentModel:
    """Standardized interface for EC019 NMC Battery -- F1b SOC-thermal model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = NMCBatteryF1b(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": "Chen et al. (2020); Ecker et al. (2015); Forgez et al. (2010)",
        }
