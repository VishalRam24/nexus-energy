"""
EC019 -- NMC Battery (Nickel Manganese Cobalt) -- F0 Empirical Round-Trip Efficiency Curve
...
Reference (reused from F1a):
    Chen et al. (2020), J. Electrochem. Soc., 167, 080534; Samsung INR21700-50E datasheet
"""
...
class NMCBatteryF0a:
    """Round-trip-efficiency lookup model for the EC019 cell."""
...
if __name__ == "__main__":
    ...
    m = NMCBatteryF0a(json.load(open(p)))
