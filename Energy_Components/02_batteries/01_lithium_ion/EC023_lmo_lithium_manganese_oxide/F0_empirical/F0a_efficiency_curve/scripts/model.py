"""
EC023 -- LMO Battery (Lithium Manganese Oxide) -- F0 Empirical Round-Trip Efficiency Curve
...
Reference (reused from F1a):
    LMO SOC-only F1a default parameters (Q_nom=2.5 Ah, R_int=30 mOhm, V 3.0-4.2 V)
"""
...
class LMOBatteryF0a:
    """Round-trip-efficiency lookup model for the EC023 cell."""
...
if __name__ == "__main__":
    ...
    m = LMOBatteryF0a(json.load(open(p)))
