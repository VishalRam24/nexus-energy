"""
EC023 -- LMO Battery -- F1b SOC-Thermal -- Standardized Predict Interface
...
from model import LMOBatteryF1b


class ComponentModel:
    """Standardized interface for EC023 LMO Battery -- F1b SOC-thermal model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = LMOBatteryF1b(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": "Liaw et al. (2003); Jalkanen et al. (2015); Thomas & Newman (2003)",
        }
