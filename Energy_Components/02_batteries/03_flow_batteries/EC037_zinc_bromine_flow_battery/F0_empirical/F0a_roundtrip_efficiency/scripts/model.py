"""F0a empirical round-trip-efficiency lookup for Zinc-Bromine Flow Battery (ZBFB) (EC037).
...
Data source (reused from EC037 F1a):
EC037 F1a (E0=1.85 V, ASR=1.5 Ohm.cm2, 1000 cm2, 60 cells); ZBFB round-trip eff ~65-75% (Skyllas-Kazacos et al. 2011).
