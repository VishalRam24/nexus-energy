"""Optional Plotly report for Zinc-Bromine Flow Battery (ZBFB) (EC037) F0a. Wrapped so absence of plotly is harmless."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="Zinc-Bromine Flow Battery (ZBFB) (EC037) F0a round-trip efficiency",
