"""Optional Plotly report for Vanadium Redox Flow Battery (VRFB) (EC036) F0a. Wrapped so absence of plotly is harmless."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="Vanadium Redox Flow Battery (VRFB) (EC036) F0a round-trip efficiency",
