"""F0a empirical round-trip-efficiency lookup for Vanadium Redox Flow Battery (VRFB) (EC036).
...
Data source (reused from EC036 F1a):
EC036 F1a (E0=1.26 V, ASR=0.8 Ohm.cm2, 600 cm2, 40 cells); VRFB DC round-trip eff ~70-80% (Blanc & Rufer 2010).
