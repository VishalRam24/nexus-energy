"""
EC038 -- Iron-Chromium Flow Battery -- F1b SOC-Thermal -- Simulation & HTML Report Generator

ICFB operates from 15-65 degC, wider range than Zn-Br2 systems.
"""
...
def generate_report():
    ...
    # ICFB: 15-65 degC
    temperatures = [288.15, 298.15, 313.15, 323.15, 338.15]
    temp_labels = ["15C (288K)", "25C (298K)", "40C (313K)", "50C (323K)", "65C (338K)"]
    colors = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd"]

    soc = np.linspace(0.05, 0.95, 200)
    discharge_current = 40.0
    ...
    T_range = np.linspace(288.15, 338.15, 200)
