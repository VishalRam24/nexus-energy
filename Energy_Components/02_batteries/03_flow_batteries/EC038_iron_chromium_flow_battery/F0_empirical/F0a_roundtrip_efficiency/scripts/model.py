"""F0a empirical round-trip-efficiency lookup for Iron-Chromium Flow Battery (ICFB) (EC038).
...
Data source (reused from EC038 F1a):
EC038 F1a (E0=1.18 V, ASR=1.5 Ohm.cm2, 1000 cm2, 40 cells); Fe-Cr round-trip eff ~60-75% (NASA/EPRI legacy; Zeng et al. 2019).
