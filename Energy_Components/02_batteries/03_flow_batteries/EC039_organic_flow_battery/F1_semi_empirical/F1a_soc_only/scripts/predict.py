"""
EC039 -- Organic Flow Battery -- F1a SOC-only -- Standardized Predict Interface

Usage:
    model = ComponentModel()
    result = model.predict({"soc": 0.5, "current": 20.0})
"""
...
from model import OrganicFlowBatteryModel

_PARAMS_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "parameters.json")


class ComponentModel:
    """Standardized interface for EC039 Organic Flow Battery -- F1a SOC-only model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = OrganicFlowBatteryModel(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "ec_id": "EC039",
            "fidelity": "F1a",
            "description": "Nernst OCV model; 20-cell stack, quinone-based, fixed T=298K",
            "inputs": {
                "soc": {"unit": "dimensionless", "range": [0.01, 0.99]},
                "current": {"unit": "A", "range": [-60.0, 60.0], "note": "positive=discharge"},
