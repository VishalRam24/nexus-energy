"""Tailored tests for Organic (Quinone) Flow Battery (EC039) F0a round-trip-efficiency lookup. No pytest."""
import os
import sys
import time
...
def main():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC039" and info["version"] == "1.0.0",
