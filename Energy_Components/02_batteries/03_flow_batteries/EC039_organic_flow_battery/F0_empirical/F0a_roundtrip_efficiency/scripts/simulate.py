"""Optional Plotly report for Organic (Quinone) Flow Battery (EC039) F0a. Wrapped so absence of plotly is harmless."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="Organic (Quinone) Flow Battery (EC039) F0a round-trip efficiency",
