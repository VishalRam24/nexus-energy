"""F0a empirical round-trip-efficiency lookup for Organic (Quinone) Flow Battery (EC039).
...
Data source (reused from EC039 F1a):
EC039 F1a (E0=1.0 V, ASR=2.0 Ohm.cm2, 500 cm2, 20 cells); Aqueous organic RFB round-trip eff ~60-70% (Huskinson et al. Nature 2014).
