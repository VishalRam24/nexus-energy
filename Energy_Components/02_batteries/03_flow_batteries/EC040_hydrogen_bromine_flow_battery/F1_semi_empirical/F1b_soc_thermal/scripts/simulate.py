"""
EC040 -- Hydrogen-Bromine Flow Battery -- F1b SOC-Thermal -- Simulation & HTML Report Generator

HBrFB operates from 20-60 degC, supports high current density.
"""
...
def generate_report():
    ...
    # HBrFB: 20-60 degC
    temperatures = [293.15, 303.15, 313.15, 323.15, 333.15]
    temp_labels = ["20C (293K)", "30C (303K)", "40C (313K)", "50C (323K)", "60C (333K)"]
    colors = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd"]

    soc = np.linspace(0.05, 0.95, 200)
    discharge_current = 80.0
    ...
    T_range = np.linspace(293.15, 333.15, 200)
