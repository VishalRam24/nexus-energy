"""Standardized inference API for Hydrogen-Bromine Flow Battery (HBFB) (EC040) F0a round-trip-efficiency lookup."""
import json
import os
import sys
...
class ComponentModel:
    component_id = "EC040"
    component_name = "Hydrogen-Bromine Flow Battery (HBFB)"
