"""Tailored tests for Hydrogen-Bromine Flow Battery (HBFB) (EC040) F0a round-trip-efficiency lookup. No pytest."""
import os
import sys
import time
...
def main():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC040" and info["version"] == "1.0.0",
