"""Optional Plotly report for Hydrogen-Bromine Flow Battery (HBFB) (EC040) F0a. Wrapped so absence of plotly is harmless."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="Hydrogen-Bromine Flow Battery (HBFB) (EC040) F0a round-trip efficiency",
