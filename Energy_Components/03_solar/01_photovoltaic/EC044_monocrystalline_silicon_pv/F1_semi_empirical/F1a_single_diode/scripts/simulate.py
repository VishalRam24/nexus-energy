"""EC044 — Mono-Si PV — F1a — Simulation & HTML Report"""
...
def generate_report():
    ...
    fig = make_subplots(rows=2, cols=2,
        subplot_titles=["Power vs Irradiance", "Power vs Cell Temperature",
                        "Efficiency vs Irradiance", "I-V Key Points vs Irradiance"],
        vertical_spacing=0.12)

    # Power vs Irradiance at different temperatures
    G = np.linspace(50, 1200, 100)
