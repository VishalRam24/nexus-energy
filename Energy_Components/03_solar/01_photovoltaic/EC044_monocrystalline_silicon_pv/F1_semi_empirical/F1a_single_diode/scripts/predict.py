"""EC044 — Mono-Si PV — F1a Single-Diode — Standardized Predict Interface"""

import json, numpy as np
from pathlib import Path
from model import MonoSiPVF1a


class ComponentModel:
    """Standardized interface for EC044 Mono-Si PV — F1a single-diode model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = MonoSiPVF1a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "ec_id": "EC044",
            "fidelity": "F1a",
            "description": "Single-diode model (De Soto 5-parameter) via pvlib",
            "inputs": {
            ...
            "source": "De Soto et al. (2006), Solar Energy 80(1); pvlib v0.15 BSD-3",
            "license": "BSD-3",
        }
