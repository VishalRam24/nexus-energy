"""Optional Plotly report for EC048 Perovskite Solar Cell F0a. Safe if plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC048 Perovskite Solar Cell F0a", xaxis_title="Irradiance [W/m2]",
                      yaxis_title="Output")
