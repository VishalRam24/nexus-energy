"""
EC048 -- Perovskite Solar Cell -- F2a Diode Shading -- predict interface.
"""
import json, os, sys
import numpy as np
...
class ComponentModel:
    component_id = "EC048"
    component_name = "Perovskite Solar Cell"
    fidelity = "F2a -- Diode + Partial Shading"
    version = "1.0.0"
    ...
    def __init__(self, params=None):
        ...
        self._model = PerovskitePV_DiodeShading_F2a(self._raw)
