"""Standard ComponentModel interface for EC049 Multi-Junction Concentrator PV (F0a)."""
import json
import os
import sys
...
class ComponentModel:
    component_id = "EC049"
    component_name = "Multi-Junction Concentrator PV"
    ...
    def predict(self, inputs: dict) -> dict:
        """inputs: DNI [W/m2] (or 'irradiance'), cell_temperature [degC]."""
