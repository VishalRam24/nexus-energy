"""F0a empirical rated-efficiency model for EC049 Multi-Junction Concentrator PV.
...
Data source: Luque & Hegedus (2011), Handbook of Photovoltaic Science and Engineering.
"""
import numpy as np
