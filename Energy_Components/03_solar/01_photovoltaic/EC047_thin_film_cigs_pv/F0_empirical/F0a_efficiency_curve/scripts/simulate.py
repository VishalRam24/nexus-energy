"""Optional Plotly report for EC047 Thin-Film CIGS PV F0a. Safe if plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC047 Thin-Film CIGS PV F0a", xaxis_title="Irradiance [W/m2]",
                      yaxis_title="Output")
