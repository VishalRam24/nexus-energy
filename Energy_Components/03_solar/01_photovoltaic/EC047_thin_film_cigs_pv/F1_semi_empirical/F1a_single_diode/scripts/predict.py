"""EC047 — CIGS Thin-Film PV — F1a Single-Diode — Standardized Predict Interface"""

import json, numpy as np
from pathlib import Path
from model import CIGSPVF1a


class ComponentModel:
    """Standardized interface for EC047 CIGS PV — F1a single-diode model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = CIGSPVF1a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": "De Soto et al. (2006); Solar Frontier SF170-S datasheet",
            "license": "BSD-3",
        }
