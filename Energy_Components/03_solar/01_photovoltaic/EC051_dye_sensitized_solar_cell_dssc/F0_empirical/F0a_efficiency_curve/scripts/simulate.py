"""Optional Plotly report for EC051 Dye-Sensitized Solar Cell (DSSC) F0a. Safe if plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC051 Dye-Sensitized Solar Cell (DSSC) F0a", xaxis_title="Irradiance [W/m2]",
                      yaxis_title="Output")
