"""Optional Plotly report for EC052 Bifacial PV Module F0a. Safe if plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC052 Bifacial PV Module F0a", xaxis_title="Irradiance [W/m2]",
                      yaxis_title="Output")
