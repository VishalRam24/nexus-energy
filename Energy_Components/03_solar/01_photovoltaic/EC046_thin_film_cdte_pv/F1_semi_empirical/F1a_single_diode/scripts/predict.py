"""EC046 — CdTe Thin-Film PV — F1a Single-Diode — Standardized Predict Interface"""

import json, numpy as np
from pathlib import Path
from model import CdTePVF1a


class ComponentModel:
    """Standardized interface for EC046 CdTe PV — F1a single-diode model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = CdTePVF1a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "source": "De Soto et al. (2006); First Solar Series 6 datasheet",
            "license": "BSD-3",
        }
