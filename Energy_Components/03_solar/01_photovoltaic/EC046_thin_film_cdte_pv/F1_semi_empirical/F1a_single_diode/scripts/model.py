"""
EC046 — Thin-Film CdTe PV — F1a Single-Diode Model
...
CdTe specifics:
    - Bandgap ~1.45 eV (vs 1.121 eV for c-Si) — wider bandgap, lower I_o.
    - Temperature coefficient -0.25 to -0.28 %/K — better than c-Si in hot climates.
...
class CdTePVF1a:
    """CdTe thin-film PV — De Soto 5-parameter single-diode model (pure NumPy)."""
    ...
    def __init__(self, params: dict):
        ...
        self.area = mod.get("area", {"value": 2.475})["value"]
