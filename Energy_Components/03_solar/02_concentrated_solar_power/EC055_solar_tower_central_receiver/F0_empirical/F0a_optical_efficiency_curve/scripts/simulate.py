"""Optional Plotly report for EC055 Solar Tower Central Receiver CSP F0a. Safe if plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC055 Solar Tower Central Receiver CSP F0a", xaxis_title="Irradiance [W/m2]",
                      yaxis_title="Output")
