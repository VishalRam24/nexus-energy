"""Optional Plotly report for EC054 Parabolic Trough CSP F0a. Safe if plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC054 Parabolic Trough CSP F0a", xaxis_title="Irradiance [W/m2]",
                      yaxis_title="Output")
