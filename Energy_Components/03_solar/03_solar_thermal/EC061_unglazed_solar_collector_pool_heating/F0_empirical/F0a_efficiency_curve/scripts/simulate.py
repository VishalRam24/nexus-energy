"""Optional Plotly report for EC061 Unglazed Solar Collector (Pool Heating) F0a. Safe if plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC061 Unglazed Solar Collector (Pool Heating) F0a", xaxis_title="Irradiance [W/m2]",
                      yaxis_title="Output")
