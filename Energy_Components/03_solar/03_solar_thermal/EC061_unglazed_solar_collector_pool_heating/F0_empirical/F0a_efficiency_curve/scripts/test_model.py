"""Tests for EC061 Unglazed Solar Collector (Pool Heating) F0a empirical model. No pytest."""
import os
import sys
import time
...
info = m.get_info()
assert_true(info["component_id"] == "EC061" and info["fidelity"].startswith("F0a"),
