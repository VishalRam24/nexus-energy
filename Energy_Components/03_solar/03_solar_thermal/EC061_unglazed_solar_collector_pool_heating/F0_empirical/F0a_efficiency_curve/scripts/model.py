"""F0a empirical efficiency-curve model for EC061 Unglazed Solar Collector (Pool Heating).
...
Data source: Duffie & Beckman (2013) Solar Engineering of Thermal Processes, Ch.6.
"""
import numpy as np
