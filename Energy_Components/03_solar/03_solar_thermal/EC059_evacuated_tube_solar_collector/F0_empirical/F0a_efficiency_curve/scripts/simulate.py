"""Optional Plotly report for EC059 Evacuated Tube Solar Collector F0a. Safe if plotly absent."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC059 Evacuated Tube Solar Collector F0a", xaxis_title="Irradiance [W/m2]",
                      yaxis_title="Output")
