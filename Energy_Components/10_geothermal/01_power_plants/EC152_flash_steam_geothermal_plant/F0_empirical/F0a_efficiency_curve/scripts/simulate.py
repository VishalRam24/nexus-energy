"""Optional Plotly report for EC152 F0a efficiency curve."""
import os
...
def main():
    ...
    fig.update_layout(title="EC152 Flash Steam Geothermal Plant — F0a empirical curve")
