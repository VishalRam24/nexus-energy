"""Optional Plotly report for EC154 F0a efficiency curve."""
import os
...
def main():
    ...
    fig.update_layout(title="EC154 Enhanced Geothermal System — F0a empirical curve")
