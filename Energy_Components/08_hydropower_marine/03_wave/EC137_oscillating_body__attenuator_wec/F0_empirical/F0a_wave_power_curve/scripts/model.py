"""EC137 — Oscillating Body / Attenuator WEC — F0a empirical wave-power curve.
...
Data source: Henderson (2006); Yemm et al. (2012) Pelamis P2; reuses EC137 F1a parameters. NumPy only.
"""
import numpy as np
