"""EC128 — Conventional Hydroelectric Dam — F0a empirical power-rating curve.

Simplest fidelity: a tabulated overall-efficiency curve vs flow ratio q=Q/Q_design,
interpolated with numpy.interp. Hydraulic power P = eta(q)*rho*g*Q*H/1000 (kW).
Data source: Dixon & Hall (2014); reuses EC128 F1a rated parameters.
NumPy only.
"""
import numpy as np
