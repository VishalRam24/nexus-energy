"""EC133 — Tidal Lagoon — F0a — standardized predict interface."""
...
class ComponentModel:
    ...
    def get_info(self) -> dict:
        return {
            ...
            "inputs": {
                "tidal_range_amplitude_m": {"unit": "m", "range": [0.0, 6.0],
...
if __name__ == "__main__":
    m = ComponentModel()
    r = m.predict({"tidal_range_amplitude_m": 4.5})
    print(f"At design h=4.5 m: P_avg={float(r['mean_power_mw']):.2f} MW, CF={float(r['capacity_factor']):.3f}")
