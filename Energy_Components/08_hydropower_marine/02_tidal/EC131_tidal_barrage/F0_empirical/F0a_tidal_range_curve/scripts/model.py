"""EC131 — Tidal Barrage — F0a empirical tidal-range power curve.

Simplest fidelity: tabulated mean power vs tidal-range amplitude h, P_avg ~ h^2,
interpolated with numpy.interp. Below h_min_operation power is zero.
Data source: Charlier (2003); Prandle (1984); reuses EC131 F1a parameters.
NumPy only.
"""
import numpy as np
