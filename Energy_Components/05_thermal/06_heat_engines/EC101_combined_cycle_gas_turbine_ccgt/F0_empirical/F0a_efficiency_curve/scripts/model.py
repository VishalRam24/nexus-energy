"""F0a empirical efficiency-curve lookup for EC101 Combined Cycle Gas Turbine (CCGT).
...
Data source: Kehlhofer et al. (2009), Combined-Cycle Gas & Steam Turbine Power Plants, 3rd ed.
"""
import numpy as np
