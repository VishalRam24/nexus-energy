"""Optional Plotly report for EC101 Combined Cycle Gas Turbine (CCGT) F0a."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC101 Combined Cycle Gas Turbine (CCGT) - F0a efficiency curve",
