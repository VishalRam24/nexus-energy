"""F0a empirical efficiency-curve lookup for EC102 Kalina Cycle (NH3/H2O).
...
Data source: Kalina F1a: eta=eta_2nd*eta_Carnot; eta_2nd=0.55, T_source=473K, T_sink=298K
"""
import numpy as np
