"""Optional Plotly report for EC103 Supercritical CO2 Brayton Cycle F0a."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC103 Supercritical CO2 Brayton Cycle - F0a efficiency curve",
