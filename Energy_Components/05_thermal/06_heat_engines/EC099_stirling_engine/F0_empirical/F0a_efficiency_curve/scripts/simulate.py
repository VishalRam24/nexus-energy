"""Optional Plotly report for EC099 Stirling Engine (micro-CHP scale) F0a."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC099 Stirling Engine (micro-CHP scale) - F0a efficiency curve",
