"""F0a tests for Microchannel Heat Exchanger (EC077). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC077" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC077 Microchannel Heat Exchanger F0a ==")
    run()
