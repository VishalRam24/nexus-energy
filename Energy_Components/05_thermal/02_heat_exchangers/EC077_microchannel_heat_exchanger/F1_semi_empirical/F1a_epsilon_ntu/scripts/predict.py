"""EC077 — Microchannel HX — F1a e-NTU — Standardized Predict Interface"""
import json, os, sys
import numpy as np
from pathlib import Path

sys.path.insert(0, os.path.dirname(__file__))
from model import MicrochannelHXF1a
...
class ComponentModel:
    ...
    def __init__(self, params_path=None):
        ...
        self._model = MicrochannelHXF1a(self.params)
    ...
    def get_info(self) -> dict:
        return {
            ...
            "fidelity": "F1a",
            "description": "Crossflow e-NTU (both unmixed): high UA, compact design",
            "inputs": {
                "T_h_in": {"unit": "degC", "range": [30.0, 150.0]},
                "T_c_in": {"unit": "degC", "range": [-20.0, 40.0]},
                "C_h": {"unit": "W/K", "range": [500.0, 15000.0]},
                "C_c": {"unit": "W/K", "range": [500.0, 15000.0]},
            },
            "outputs": {
                "Q_kW": {"unit": "kW"},
                "T_h_out": {"unit": "degC"},
            ...
            "source": "Incropera & DeWitt (2006); Webb & Kim (2005)",
            "license": "BSD-3",
        }
