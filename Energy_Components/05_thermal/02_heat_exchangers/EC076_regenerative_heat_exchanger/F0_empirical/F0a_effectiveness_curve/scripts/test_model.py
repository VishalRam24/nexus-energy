"""F0a tests for Regenerative Heat Exchanger (EC076). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC076" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC076 Regenerative Heat Exchanger F0a ==")
    run()
