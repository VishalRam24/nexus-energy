"""F0a tests for Shell-and-Tube Heat Exchanger (EC073). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC073" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC073 Shell-and-Tube Heat Exchanger F0a ==")
    run()
