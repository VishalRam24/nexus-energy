"""F0a tests for Plate Heat Exchanger (EC074). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC074" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC074 Plate Heat Exchanger F0a ==")
    run()
