"""F0a tests for EC089 Hydrogen Boiler (100% H2). Custom harness, no pytest. NumPy only."""
import os, sys, time
...
def main():
    ...
    assert_true(abs(r1["efficiency"] - 0.92) < 1e-6,
                "eta at PLR=1.0 equals eta_nom (0.92)")
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC089" and info["fidelity"].startswith("F0a"),
