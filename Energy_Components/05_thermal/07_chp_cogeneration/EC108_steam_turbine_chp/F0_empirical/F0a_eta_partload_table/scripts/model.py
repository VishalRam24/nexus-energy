"""F0a empirical part-load efficiency table for EC108 Steam Turbine CHP (back-pressure) (CHP).
...
Data source: US EPA CHP Catalog (2017); IEA (2008) Combined Heat and Power
"""
import numpy as np
