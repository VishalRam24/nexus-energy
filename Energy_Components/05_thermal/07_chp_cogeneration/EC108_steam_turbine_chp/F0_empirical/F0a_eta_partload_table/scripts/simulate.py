"""Optional Plotly report for EC108 Steam Turbine CHP (back-pressure) F0a CHP."""
import os
import sys
...
def main():
    ...
    fig.update_layout(title="EC108 Steam Turbine CHP (back-pressure) - F0a part-load efficiencies",
