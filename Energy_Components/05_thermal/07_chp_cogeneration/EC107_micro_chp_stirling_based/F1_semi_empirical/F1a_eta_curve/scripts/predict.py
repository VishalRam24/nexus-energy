"""
EC107 -- Stirling Engine Micro-CHP -- F1a Efficiency Curve -- Standardized Predict Interface
...
from model import StirlingCHPModel

_PARAMS_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "parameters.json")


class ComponentModel:
    """Standardized interface for EC107 Stirling Micro-CHP -- F1a eta-curve model."""
    ...
    def __init__(self, params_path=None):
        ...
        self._model = StirlingCHPModel(self.params)
    ...
    def get_info(self) -> dict:
        return {
            "name": "Stirling Engine Micro-CHP",
            "ec_id": "EC107",
            "fidelity": "F1a",
            "description": "Eta-curve: eta_e=0.15*f(load), eta_th=0.70*f(load), f=0.2+0.8*load, P_e_rated=1kW",
            "inputs": {
