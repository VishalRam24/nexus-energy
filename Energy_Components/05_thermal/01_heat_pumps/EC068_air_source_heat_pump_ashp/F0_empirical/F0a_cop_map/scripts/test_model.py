"""F0a tests for Air-Source Heat Pump (ASHP) (EC068). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC068" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC068 Air-Source Heat Pump (ASHP) F0a ==")
    run()
