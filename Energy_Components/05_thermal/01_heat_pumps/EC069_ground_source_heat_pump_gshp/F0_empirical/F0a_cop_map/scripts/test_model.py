"""F0a tests for Ground-Source Heat Pump (GSHP) (EC069). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC069" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC069 Ground-Source Heat Pump (GSHP) F0a ==")
    run()
