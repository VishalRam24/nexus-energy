"""F0a tests for Absorption Heat Pump (EC071). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC071" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC071 Absorption Heat Pump F0a ==")
    run()
