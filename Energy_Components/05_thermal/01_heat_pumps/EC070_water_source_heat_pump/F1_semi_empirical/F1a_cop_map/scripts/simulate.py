"""EC070 — WSHP — F1a — Simulation & HTML Report"""
...
def generate_report():
    ...
    fig = make_subplots(rows=2, cols=2,
        subplot_titles=["COP vs T_source (water)", "COP vs T_sink", "Electrical Input vs T_source", "COP Map (Heatmap)"],
        vertical_spacing=0.12)

    Ts = np.linspace(5, 30, 100)
