"""F0a tests for CO2 Transcritical Heat Pump (EC072). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC072" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC072 CO2 Transcritical Heat Pump F0a ==")
    run()
