"""F0a tests for PCM Storage (Paraffin RT42) (EC080). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC080" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC080 PCM Storage (Paraffin RT42) F0a ==")
    run()
