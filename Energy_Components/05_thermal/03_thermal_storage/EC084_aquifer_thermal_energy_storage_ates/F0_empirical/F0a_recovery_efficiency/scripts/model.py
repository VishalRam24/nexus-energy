"""Empirical storage recovery-efficiency lookup for EC084 Aquifer Thermal Energy Storage (ATES).

eta_store tabulated against storage temperature and read with np.interp.
Energy returned = eta_store * energy charged.
Source: Bloemendal et al. (2014) ATES systems performance review, Geothermics
"""
import numpy as np
