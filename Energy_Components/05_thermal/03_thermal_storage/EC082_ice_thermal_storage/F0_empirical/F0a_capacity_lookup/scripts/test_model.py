"""F0a tests for Ice Thermal Storage (EC082). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC082" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC082 Ice Thermal Storage F0a ==")
    run()
