"""F0a tests for Hot Water Tank TES (EC078). NumPy-only, no pytest."""
import os, sys, time
...
def run():
    ...
    info = m.get_info()
    assert_true(info["component_id"] == "EC078" and "valid_ranges" in info,
...
if __name__ == "__main__":
    print("== EC078 Hot Water Tank TES F0a ==")
    run()
