"""F0a predict interface for EC091 Vapor Compression Chiller (R134a).
...
class ComponentModel:
    component_id = "EC091"
    component_name = "Vapor Compression Chiller (R134a)"
    ...
    def get_info(self):
        return {
            ...
            "inputs": {'T_cond_C': 'driving variable', 'part_load_ratio': '0-1 (-)'},
...
if __name__ == "__main__":
    m = ComponentModel()
    print(m.get_info())
    print("sample:", m.predict({"T_cond_C": 35.0}))
