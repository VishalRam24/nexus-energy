"""Empirical COP map for EC092 Single-Effect LiBr-H2O Absorption Chiller.
...
Source: Herold, Radermacher & Klein (2016) Absorption Chillers and Heat Pumps, 2nd ed., CRC
"""
import numpy as np
