"""F0a predict interface for EC095 Thermoelectric Cooler (Peltier, Bi2Te3).
...
class ComponentModel:
    component_id = "EC095"
    component_name = "Thermoelectric Cooler (Peltier, Bi2Te3)"
...
if __name__ == "__main__":
    m = ComponentModel()
    print(m.get_info())
    print("sample:", m.predict({"dT_lift_K": 20.0}))
