"""F0a predict interface for EC093 Silica-Gel/Water Adsorption Chiller.
...
class ComponentModel:
    component_id = "EC093"
    component_name = "Silica-Gel/Water Adsorption Chiller"
    ...
    def get_info(self):
        return {
            ...
            "inputs": {'T_hot_C': 'driving variable', 'part_load_ratio': '0-1 (-)'},
...
if __name__ == "__main__":
    m = ComponentModel()
    print(m.get_info())
    print("sample:", m.predict({"T_hot_C": 85.0}))
