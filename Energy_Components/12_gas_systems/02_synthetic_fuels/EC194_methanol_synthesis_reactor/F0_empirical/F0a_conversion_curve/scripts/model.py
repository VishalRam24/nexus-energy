"""F0a empirical lookup model for EC194 — Methanol Synthesis Reactor.
...
Source: Graaf et al. (1988) Chem. Eng. Sci. 43:3185 (F1b params reused)
Metric: conversion_vs_temperature
Cu/ZnO/Al2O3 methanol per-pass CO conversion vs temperature (rising branch to optimum). X_max 0.75 at T_opt 250 degC, 80 bar, H2/CO=2.1.
"""
import numpy as np
