"""F0a empirical lookup model for EC195 — Ammonia Synthesis (Haber-Bosch).
...
Source: Appl (2011) Ammonia, Ullmann's Encyclopedia of Industrial Chemistry (F1a params reused)
Metric: conversion_vs_temperature
Fe-catalyzed Haber-Bosch per-pass N2 conversion vs temperature (rising branch). X ~0.15-0.20 per pass at 450 degC, 200 bar (equilibrium-limited, high recycle).
"""
import numpy as np
