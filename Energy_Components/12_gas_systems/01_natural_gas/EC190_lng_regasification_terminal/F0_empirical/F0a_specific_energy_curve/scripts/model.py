"""F0a empirical lookup model for EC190 — LNG Regasification Terminal.
...
Source: Mokhatab et al. (2014) Handbook of Liquefied Natural Gas, Elsevier; IEA (2017) (F1a params reused)
Metric: specific_energy_vs_partload
Specific energy consumption (kWh/ton LNG) vs sendout part-load ratio. Base SEC 50 kWh/ton at full load; rises at low load due to fixed parasitic losses.
"""
import numpy as np
