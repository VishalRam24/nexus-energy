"""Standardized predict interface for EC190 F0a — LNG Regasification Terminal."""
import json
import os
import sys
...
class ComponentModel:
    ...
    def __init__(self, params_path=_PARAMS):
        ...
        self.model = LookupCurve(lk[self._x_key]["value"], lk[self._y_key]["value"])

    def predict(self, inputs: dict) -> dict:
        """inputs: {'part_load_ratio': value-or-array} -> {'specific_energy_kWh_per_ton': ...}."""
