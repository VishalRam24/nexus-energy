"""Tailored tests for EC011 F0a — Anion Exchange Membrane Electrolyser (AEM). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    print("Testing EC011 Anion Exchange Membrane Electrolyser (AEM) (F0a)")
