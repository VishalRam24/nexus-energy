"""F0a empirical lookup model for EC011 — Anion Exchange Membrane Electrolyser (AEM).
...
Source: Vincent & Bessarabov (2018) RSER, 81, 1690 (F1a params reused)
Metric: h2_production_efficiency_LHV
AEM efficiency ~55-70%; Faraday eff 0.97 (gas crossover). Between PEM and alkaline.
"""
import numpy as np
