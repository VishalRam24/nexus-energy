"""F0a empirical lookup model for EC008 — PEM Electrolyser (PEMEL).
...
Source: Garcia-Valverde et al. (2012), IJHE, 37(2), 1927-1938 (F1a params reused)
Metric: h2_production_efficiency_LHV
PEMEL efficiency (LHV H2 out / electrical in) ~60-75%; drops at high current (ohmic). ~50 kWh/kg at rated.
"""
import numpy as np
