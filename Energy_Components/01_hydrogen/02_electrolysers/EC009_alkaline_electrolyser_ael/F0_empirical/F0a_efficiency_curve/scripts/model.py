"""F0a empirical lookup model for EC009 — Alkaline Electrolyser (AEL).
...
Source: Ulleberg (2003), IJHE, 28(1), 21-33 (F1a params reused)
Metric: h2_production_efficiency_LHV
AEL efficiency ~60-72%; mature, slightly lower than PEM at part load due to bubble overpotential.
"""
import numpy as np
