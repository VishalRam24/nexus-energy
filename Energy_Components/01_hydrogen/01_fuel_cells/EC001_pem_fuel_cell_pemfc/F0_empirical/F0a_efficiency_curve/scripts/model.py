"""F0a empirical lookup model for EC001 — PEM Fuel Cell (PEMFC).
...
Source: Amphlett et al. (1995), J. Electrochem. Soc., 142(1), 1-8 (F1a params reused)
Metric: electrical_efficiency_LHV
PEMFC stack efficiency peaks at low/part load, drops at high load (concentration/ohmic losses). Peak ~58%, rated 50% @ 60% load.
"""
import numpy as np
