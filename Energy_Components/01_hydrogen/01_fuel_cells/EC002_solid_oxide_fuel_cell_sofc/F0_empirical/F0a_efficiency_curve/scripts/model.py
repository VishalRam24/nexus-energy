"""F0a empirical lookup model for EC002 — Solid Oxide Fuel Cell (SOFC).
...
Source: Chan et al. (2001), J. Power Sources, 93, 130-140 (F1a params reused)
Metric: electrical_efficiency_LHV
SOFC high electrical efficiency (~55-60%) due to high T and low activation loss. Peak ~62%.
"""
import numpy as np
