"""F0a empirical lookup model for EC004 — Phosphoric Acid Fuel Cell (PAFC).
...
Source: Larminie & Dicks (2003); PAFC F1a params reused
Metric: electrical_efficiency_LHV
PAFC electrical efficiency ~40-45%; higher ohmic loss (R_ohm 0.5 ohm.cm2).
"""
import numpy as np
