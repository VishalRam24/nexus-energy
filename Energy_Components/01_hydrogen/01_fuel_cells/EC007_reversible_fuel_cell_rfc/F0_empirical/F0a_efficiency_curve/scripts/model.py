"""F0a empirical lookup model for EC007 — Reversible Fuel Cell (RFC).
...
Source: RFC F1a params reused (E_rev=1.23 V, FC & EL modes)
Metric: roundtrip_efficiency_LHV
RFC round-trip efficiency (FC eff x EL eff) ~35-45%; rated 40% at mid load.
"""
import numpy as np
