"""F0a empirical lookup model for EC005 — Molten Carbonate Fuel Cell (MCFC).
...
Source: MCFC F1a params reused (T=923 K, CO3^2- transport)
Metric: electrical_efficiency_LHV
MCFC high-T efficiency ~50%; low R_ohm (0.1 ohm.cm2) gives flatter curve.
"""
import numpy as np
