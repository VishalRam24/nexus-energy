"""F0a empirical lookup model for EC006 — Direct Methanol Fuel Cell (DMFC).
...
Source: DMFC F1a params reused (OCV~0.6 V, methanol crossover, n=6)
Metric: electrical_efficiency_LHV
DMFC low efficiency (~20-30%) due to methanol crossover (low OCV ~0.6 V).
"""
import numpy as np
