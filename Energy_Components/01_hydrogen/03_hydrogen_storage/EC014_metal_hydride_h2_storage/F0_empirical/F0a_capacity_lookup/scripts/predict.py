"""Standardized predict interface for EC014 F0a — Metal Hydride H2 Storage (LaNi5)."""
import json
import os
import sys
...
from model import CapacityLookup  # noqa: E402
...
class ComponentModel:
    component_id = "EC014"
    component_name = "Metal Hydride H2 Storage (LaNi5)"
    ...
    def __init__(self, params_path=_PARAMS):
        ...
        self.model = CapacityLookup(lk[self._x_key]["value"], lk[self._y_key]["value"])

    def predict(self, inputs: dict) -> dict:
        """inputs: {'T_K': value-or-array} -> {'plateau_pressure_bar': ...}."""
