"""F0a empirical lookup model for EC014 — Metal Hydride H2 Storage (LaNi5).
...
Source: Sandrock (1999); Sakintuna et al. (2007) IJHE (F1a params reused)
Metric: plateau_pressure_vs_temperature
LaNi5 desorption plateau pressure (bar) from van't Hoff (dH=-30.1 kJ/mol, dS=-108 J/mol/K). ~2.3 bar @ 20 C. Bed capacity 0.14 kg H2 (1.4 wt%, 10 kg bed).
"""
import numpy as np
