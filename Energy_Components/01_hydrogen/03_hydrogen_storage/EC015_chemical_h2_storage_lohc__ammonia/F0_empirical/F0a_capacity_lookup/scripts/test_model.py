"""Tailored tests for EC015 F0a — Chemical H2 Storage (LOHC / Ammonia). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    print("Testing EC015 Chemical H2 Storage (LOHC / Ammonia) (F0a)")
    ...
    raw = CapacityLookup(xs.tolist(), ys.tolist())
