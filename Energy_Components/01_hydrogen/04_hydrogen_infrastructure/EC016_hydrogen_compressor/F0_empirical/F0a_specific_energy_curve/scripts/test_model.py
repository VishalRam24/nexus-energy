"""Tailored tests for EC016 F0a — Hydrogen Compressor. NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    print("Testing EC016 Hydrogen Compressor (F0a)")
    ...
    raw = SpecificEnergyCurve(xs.tolist(), ys.tolist())
