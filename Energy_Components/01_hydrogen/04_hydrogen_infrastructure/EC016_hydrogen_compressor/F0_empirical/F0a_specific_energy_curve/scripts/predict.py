"""Standardized predict interface for EC016 F0a — Hydrogen Compressor."""
import json
import os
import sys
...
from model import SpecificEnergyCurve  # noqa: E402
...
class ComponentModel:
    ...
    def __init__(self, params_path=_PARAMS):
        ...
        self.model = SpecificEnergyCurve(lk[self._x_key]["value"], lk[self._y_key]["value"])

    def predict(self, inputs: dict) -> dict:
        """inputs: {'pressure_ratio': value-or-array} -> {'specific_energy_kWh_per_kg': ...}."""
