"""Standardized predict interface for EC017 F0a — Hydrogen Purifier (PSA)."""
import json
import os
import sys
...
from model import RecoveryLookup  # noqa: E402
...
class ComponentModel:
    component_id = "EC017"
    component_name = "Hydrogen Purifier (PSA)"
    ...
    def __init__(self, params_path=_PARAMS):
        ...
        self.model = RecoveryLookup(lk[self._x_key]["value"], lk[self._y_key]["value"])

    def predict(self, inputs: dict) -> dict:
        """inputs: {'feed_h2_fraction': value-or-array} -> {'recovery_fraction': ...}."""
