"""Tailored tests for EC017 F0a — Hydrogen Purifier (PSA). NumPy only, no pytest."""
import os
import sys
import time
...
def main():
    ...
    print("Testing EC017 Hydrogen Purifier (PSA) (F0a)")
    ...
    raw = RecoveryLookup(xs.tolist(), ys.tolist())
