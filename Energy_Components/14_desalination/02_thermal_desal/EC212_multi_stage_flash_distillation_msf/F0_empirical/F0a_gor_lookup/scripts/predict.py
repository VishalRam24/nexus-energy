"""Standardized prediction interface for the EC212 MSF F0a GOR lookup."""
import json
import os
import numpy as np
...
class ComponentModel:
    ...
    def predict(self, inputs: dict) -> dict:
        T_top = inputs.get("T_top_brine_C", self.lookup.T_top_rated)
...
if __name__ == "__main__":
    m = ComponentModel()
    print(m.get_info())
    print("sample @ T_top=110C:", m.predict({"T_top_brine_C": 110.0}))
    print("sample @ T_top=95C:", m.predict({"T_top_brine_C": 95.0}))
