"""EC213 MED F0a — empirical GOR-vs-top-temperature lookup.

MED Gain Output Ratio (kg distillate / kg steam) increases with top brine
temperature as the available temperature range across the effects widens. 1-D
np.interp over a tabulated (T_top, GOR) breakpoint array; thermal SEC is the
rated datasheet value (latent heat / GOR cross-check available).

Source: El-Dessouky & Ettouney (2002); Al-Sahali & Ettouney (2007) (reused from
EC213 F1a). NumPy only.
"""
import numpy as np
