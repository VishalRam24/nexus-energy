"""F0a predict interface for EC201 Direct Air Capture (DAC) -- Solid Sorbent."""
import os, sys, json

sys.path.insert(0, os.path.dirname(__file__))
from model import EnergyLookup  # noqa: E402
...
class ComponentModel:
    ...
    def __init__(self, params_path=_PARAMS):
        ...
        self.model = EnergyLookup(self.params)
    ...
    def get_info(self):
        return {
            ...
            "inputs": {'air_flow_m3h': 'm3/hr', 'ambient_temp': 'degC'},
            "outputs": {'co2_captured_kg_h': 'kg/hr', 'total_energy_kWh_tCO2': 'kWh/tCO2'},
...
if __name__ == "__main__":
    ...
    for k, v in m.predict({'air_flow_m3h': 1000000.0, 'ambient_temp': 25.0}).items():
        print("  {} = {}".format(k, v))
